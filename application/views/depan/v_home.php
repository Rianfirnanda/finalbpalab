...
<head>
    ...
    <title>Administrasi Publik | Fisip Unib </title>
...
<body>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        ...
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>administrasipublik@unib.ac.id
                        </div>
                        <div class="header-top_list">
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="<?php echo base_url() . 'theme/images/slider.jpg' ?>" alt="First slide">
                        <div class="carousel-caption d-md-block">
                            <div class="slider_title">
                                ...
                                <div class="slider-btn">
                                    <a href="<?php echo site_url('artikel'); ?>" class="btn btn-default btn-brown">Lihat Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url() . 'theme/images/slider-2.jpg' ?>" alt="Second slide">
                        <div class="carousel-caption d-md-block">
                            <div class="slider_title">
                                ...
                                <div class="slider-btn">
                                    <a href="<?php echo site_url('guru'); ?>" class="btn btn-default btn-brown">Lihat Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?php echo base_url() . 'theme/images/slider-3.jpg' ?>" alt="Third slide">
                        <div class="carousel-caption d-md-block">
                            <div class="slider_title">
                                ...
                                <div class="slider-btn">
                                    <a href="<?php echo site_url('galeri'); ?>" class="btn btn-default btn-brown">Lihat Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="clearfix about about-style2">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h2>Sambutan Kepala Jurusan</h2>
                    <p>Assalamu’alaikum Wr. Wb.</p>

                    <p>Selamat datang di website Program Studi Administrasi Publik Universitas Bengkulu. Saya Suratman, S.IP., M.Si, Kepala Jurusan, menyampaikan sambutan hangat kepada seluruh pengunjung. Melalui sinergi pendidikan, penelitian, dan pengabdian, kami berkomitmen mencetak lulusan yang unggul, profesional, dan inovatif dalam mengembangkan pelayanan publik. Semoga informasi di sini dapat memberikan manfaat dan inspirasi bagi Anda.</p>

                    <p>Wassalamu’alaikum Wr. Wb.</p>
                    <p><b>Suratman S.ip., M.si</b></p>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <a href="<?php echo site_url('artikel'); ?>" class="btn btn-default btn-brown btn-courses">Lihat Selengkapnya</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 chart_bottom chart_top">
                    ...
                    <div class="chart-text">
                        <p><span class="counter"><?php echo $tot_siswa; ?></span> Mahasiswa Berprestasi
                        </p>
                    </div>
                </div>
