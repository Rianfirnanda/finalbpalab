...
<head>
    ...
    <title>Public Administration Unib > Mahasiswa</title>
          ...
          <div class="row">
              <div class="col-xs-6 col-sm-8 col-md-9">
                  <div class="header-top_address">
                      ...
                      <div class="header-top_list">
                          <span class="icon-envelope-open"></span>admpublikfisip@unib.ac.id
                      </div>
                      <div class="header-top_list">
                          <span class="icon-location-pin"></span>Jl. WR. Supratman, Kandang Limun, Bengkulu 38371
                      </div>
                  </div>
...
<!--//END HEADER -->
    ...
    <section class="our-teachers">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mb-5">Mahasiswa Berprestasi Kami</h2>
                </div>
            </div>
            <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="admission_insruction">
                ...
                <p class="text-center mt-3">
                    <strong><?php echo $row->siswa_nama;?></strong>
                    <br>
                    NPM: <?php echo $row->siswa_nis;?>
                    <br>
                    Jenis Kelamin: <?php echo ($row->siswa_jenkel == 'L') ? 'Laki-laki' : 'Perempuan';?>
                    <br>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <div class="address">
                            <h3>Hubungi Kami</h3>
                            <p><span>Alamat: </span> Jl. WR. Supratman, Kandang Limun, Kec. Muara Bangka Hulu, Bengkulu 38371</p>
